	...
	public ArrayList<MovimientoDTO> obtenerMovimientos(){
		...
		try {
			...
			while (resultado.next() == true) {
				...
				MovimientoDTO Movimiento = new MovimientoDTO(id, idCuentaOrigen, idCuentaDestino,cantidad,fechaDelMovimiento);
	...
	public ArrayList<MovimientoDTO> obtenerMovimiento(int id){
		...
		try {
			...
			while (resultado.next() == true) {
				...
				float cantidad = resultado.getFloat("cantidad");
				Date fechaDelMovimiento = resultado.getDate("fecha_del_movimiento");
				MovimientoDTO Movimiento = new MovimientoDTO(idMovimientos, idCuentaOrigen, idCuentaDestino,cantidad,fechaDelMovimiento);
